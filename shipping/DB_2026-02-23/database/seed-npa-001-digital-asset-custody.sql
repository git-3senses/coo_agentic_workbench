...
('NPA-2026-001','problem_statement','Institutional clients in APAC increasingly demand regulated, bank-grade custody for digital assets (BTC, ETH, stablecoins). DBS currently has no custody capability, forcing clients to use third-party custodians with higher settlement and counterparty risk.','MANUAL',100.00),
('NPA-2026-001','value_proposition','First-mover bank-grade institutional digital asset custody in APAC combining DBS credit strength with Fireblocks MPC technology. Expected to capture $2B AUM within 12 months at 15bps custody fee + 25bps transaction fee.','MANUAL',100.00),
('NPA-2026-001','customer_benefit','Institutional clients gain: (1) Regulated bank custodian with SG MAS and HK SFC oversight, (2) $500M per-client insurance via Lloyds, (3) Segregated cold-wallet storage, (4) Real-time portfolio reporting via DBS portal.','MANUAL',100.00),
('NPA-2026-001','bu_benefit','Treasury & Markets: $12.8M estimated annual revenue Year 1. Positions DBS as institutional digital asset infrastructure provider. Supports Group digital transformation KPI for 2026.','MANUAL',100.00),
...
('NPA-2026-001','target_roi','ROAE 22%+ by Year 2 (above DBS 15% minimum threshold)','MANUAL',100.00),
...
('NPA-2026-001','customer_suitability','Client must: (1) meet AI threshold (net assets >$2M), (2) pass enhanced KYC/CDD, (3) sign digital asset custody agreement, (4) complete DBS digital asset risk disclosure acknowledgement','MANUAL',100.00),
('NPA-2026-001','customer_geographic','Singapore, Hong Kong. Planned expansion to Japan and Australia in Year 2.','MANUAL',100.00),
('NPA-2026-001','distribution_channels','DBS Vickers Institutional platform, Direct relationship manager coverage, API integration for large institutional clients','MANUAL',100.00),
...
('NPA-2026-001','competitive_landscape','Key competitors: Anchorage Digital (US), Copper.co (UK), BitGo (US). DBS differentiator: regulated bank with existing institutional relationships + onshore SG/HK presence.','ADAPTED',85.00),
('NPA-2026-001','market_opportunity','Global institutional digital asset custody AUM estimated $20T by 2030. APAC institutional segment: $3.5T. DBS target: 5% APAC market share = $175B long-term AUM.','ADAPTED',82.00),
...
('NPA-2026-001','customer_accreditation','AI certification required. Digital asset risk disclosure signed. Custody agreement with DBS Bank Ltd executed.','MANUAL',100.00),
('NPA-2026-001','staff_training','All Digital Assets desk staff to complete: DBS Digital Asset Custody certification (8 hours), Fireblocks operations training (4 hours), AML for digital assets (3 hours). Mandatory before go-live.','MANUAL',100.00),
...
('NPA-2026-001','back_office_model','Existing DBS settlement operations augmented with digital asset training. Custodian reconciliation with Fireblocks ledger daily. Manual exception handling for on-chain disputes.','MANUAL',100.00),
...
('NPA-2026-001','booking_legal_form','Custody Agreement (bespoke DBS Digital Asset Custody Agreement)','MANUAL',100.00),
...
('NPA-2026-001','confirmation_process','Automated: Fireblocks generates transaction confirmation PDF. On-chain TX hash sent to client. DBS Custody Portal updated in real-time. Daily custody statement emailed at 08:00 SGT.','MANUAL',100.00),
('NPA-2026-001','reconciliation','Daily: Fireblocks ledger vs DBS internal custody ledger. Weekly: Client statement reconciliation. Monthly: Independent third-party address balance check. Any discrepancy >$1K escalated to Ops Head within 1 hour.','MANUAL',100.00),
...
('NPA-2026-001','tech_requirements','(1) Fireblocks API integration into DBS systems, (2) Digital Asset Custody Portal (new Angular UI module), (3) Elliptic real-time screening webhook, (4) CoinMetrics NAV pricing API, (5) Internal blockchain ledger module','MANUAL',100.00),
('NPA-2026-001','system_integration','Fireblocks → DBS Custody Ledger (real-time webhook), Elliptic → DBS AML system (pre-transaction screening), CoinMetrics → DBS pricing engine (every 15 minutes), DBS Portal → Client-facing reporting','MANUAL',100.00),
...
('NPA-2026-001','trade_capture_system','Custom DBS Digital Asset Custody Ledger (new build)','MANUAL',100.00),
('NPA-2026-001','risk_system','Elliptic + internal DBS risk dashboard. Fireblocks risk controls for transaction limits.','MANUAL',100.00),
('NPA-2026-001','reporting_system','DBS Digital Asset Custody Portal (new). Client statements via portal + email. Regulatory reporting to MAS via existing MAS MASNET.','MANUAL',100.00),
...
('NPA-2026-001','iss_deviations','HSM key management process partially deviates from DBS ISS Policy 3.2 (designed for traditional securities). Formal ISS deviation approved by CISO on 2025-10-15 (Ref: ISS-DEV-2025-012).','MANUAL',100.00),
...
('NPA-2026-001','dr_testing_plan','Quarterly DR test: failover to DBS Singapore DR site, Fireblocks backup cloud geographies. Test simulates Fireblocks API outage + manual signing fallback. Last test: Q4 2025, result: PASS at 2.5h RTO.','MANUAL',100.00),
...
('NPA-2026-001','continuity_measures','Fireblocks provides 3-geography resilience (US, EU, Asia nodes). DBS maintains offline emergency signing kit with HSM hardware tokens in Singapore and Hong Kong vaults.','MANUAL',100.00),
...
('NPA-2026-001','limit_monitoring','Fireblocks policy engine enforces real-time limits. DBS custody ops dashboard reviews daily limit utilisation. Alerts at 80% of daily limit.','MANUAL',100.00),
...
('NPA-2026-001','pricing_model_name','DBS Digital Custody Fee Model v1.0','MANUAL',100.00),
...
('NPA-2026-001','market_risk','Custody product: DBS bears no direct market risk on client assets (off-balance sheet). Residual FX risk on USD-denominated custody fees collected in SGD. Daily VaR on fee book: ~$12K. Within standard GFM Treasury limits.','ADAPTED',88.00),
...
('NPA-2026-001','stress_test_results','Stress testing completed as part of initial risk assessment. All scenarios show DBS maintains ability to return client assets. Maximum operational loss scenario: $8M (Fireblocks breach, partial loss before detection). Covered by $500M Lloyds insurance.','MANUAL',100.00),
...
('NPA-2026-001','esg_assessment','Neutral to positive. BTC mining energy concerns acknowledged but DBS is a custodian only — not a miner. DBS ESG policy: custody does not constitute endorsement. Client assets include ETH (PoS, low energy) and stablecoins.','MANUAL',90.00),
('NPA-2026-001','esg_classification','Neutral','AUTO',85.00),
('NPA-2026-001','exposure_limits','No credit exposure limits applicable. Operational risk concentration limit: Max 30% of AUM from single client. Max vendor concentration: Fireblocks approved as Tier 1 Critical vendor with DBS TPRM framework.','MANUAL',100.00),
...
('NPA-2026-001','legal_opinion','Baker McKenzie HK opinion commissioned for SFC Type 1 license assessment. Expected delivery: January 2026. Allen & Gledhill SG opinion completed: MAS CMS extension pathway confirmed. (AG-2025-DBS-2245)','MANUAL',100.00),
...
('NPA-2026-001','tax_impact','Singapore: No GST on custody fees (financial services exemption). Capital gains: N/A (DBS is custodian). Withholding tax on fees from HK clients: 0% under DBS HK treaty. Transfer pricing: annually reviewed FTP policy.','ADAPTED',88.00),
('NPA-2026-001','accounting_book','Banking Book','AUTO',95.00),
('NPA-2026-001','fair_value_treatment','Client digital assets not on DBS balance sheet. Custody fees recognised on accrual basis. Insurance premium: straight-line amortisation over 12 months.','MANUAL',100.00),
('NPA-2026-001','on_off_balance','Off-Balance Sheet','AUTO',99.00),
('NPA-2026-001','tax_jurisdictions','SG: GST Exempt (financial services). HK: Profits Tax — branch income. No US nexus. Transfer pricing: DBS SG principal, DBS HK agent.','MANUAL',100.00),
...
-- ================================================================
('NPA-2026-001','data_governance','Data Governance Owner: Head of Digital Assets. Data mapped under DBS Group Data Governance Framework v3.2. Digital asset transaction data classified as CLIENT CONFIDENTIAL.','MANUAL',100.00),
('NPA-2026-001','data_ownership','DBS Bank Ltd Singapore owns client data. Fireblocks holds key fragments only — contractually prohibited from using client data.','MANUAL',100.00),
...
('NPA-2026-001','data_privacy','MAS TRM compliant data storage (SG primary DC). PDPA compliant — client data processing covered under updated DBS Privacy Policy. HK PDPO compliant for HK clients. No data shared outside SG/HK without client consent.','MANUAL',100.00),
...
('NPA-2026-001','pure_purposeful','Client digital asset data used solely for custody services, regulatory compliance, and client reporting. No secondary use for DBS proprietary trading. Fireblocks contractually restricted from secondary use.','MANUAL',100.00),
...
('NPA-2026-001','pure_explainable','Annual privacy notice to all clients. Client portal provides full transparency on data held. DPO available for queries: dpo@dbs.com','MANUAL',100.00),
...
('NPA-2026-001','data_lineage','Transaction lineage: on-chain TX hash → Fireblocks ledger → DBS custody ledger → client portal. Full audit trail maintained. Immutable blockchain record as golden source.','MANUAL',100.00),
...
-- ================================================================
('NPA-2026-001','booking_entity','DBS Bank Ltd, Singapore (primary). DBS Bank (Hong Kong) Limited for HK-domiciled clients.','MANUAL',100.00),
('NPA-2026-001','sales_entity','DBS Vickers Securities (Singapore), DBS Asia Capital Limited (Hong Kong)','MANUAL',100.00),
...
('NPA-2026-001','risk_taking_entity','DBS Bank Ltd Singapore','MANUAL',100.00),
('NPA-2026-001','risk_taking_location','Singapore','MANUAL',100.00),
('NPA-2026-001','processing_entity','DBS Bank Ltd Singapore (Digital Assets Operations)','MANUAL',100.00),
...
-- ================================================================
('NPA-2026-001','dbs_ip_exists','Yes','MANUAL',100.00),
('NPA-2026-001','dbs_ip_details','DBS Digital Asset Custody Portal (new Angular-based client portal). DBS proprietary operational SOP for custody. DBS Digital Asset Custody Agreement template.','MANUAL',100.00),
('NPA-2026-001','third_party_ip_exists','Yes','MANUAL',100.00),
('NPA-2026-001','third_party_ip_details','Fireblocks: MPC technology (licensed), Elliptic: blockchain analytics engine (licensed), CoinMetrics: pricing data (licensed). All IP licensed to DBS, not owned.','MANUAL',100.00),
...
('NPA-2026-001','fraud_risk','Key fraud risks: (1) Social engineering targeting custody ops staff — mitigated by withdrawal approval matrix and phone verification. (2) Fake client impersonation — mitigated by 2FA on DBS custody portal. (3) Internal fraud — mitigated by dual control signing and comprehensive audit logging.','MANUAL',100.00),
('NPA-2026-001','bribery_corruption','Low risk — DBS Digital Assets staff subject to DBS Code of Conduct and Anti-Bribery policy. Annual anti-bribery training mandatory. Gift and entertainment policy applies.','MANUAL',100.00),
...
('NPA-2026-001','fc_policy_framework','DBS AML/CFT Policy (Group), DBS Digital Asset AML Procedures DA-001 (new — pending MLRO approval), MAS Notice 626 (AML for DPT licensees)','MANUAL',100.00),
...
('NPA-2026-001','fc_transaction_monitoring','Elliptic + DBS FCRM system. Rules: (1) Transaction >$100K auto-triggers enhanced review, (2) New wallet address: 24h hold, (3) High-risk token (mixing, privacy coins): block + MLRO review.','MANUAL',100.00),
...
('NPA-2026-001','fc_record_keeping','All KYC, transaction, and screening records retained for 7 years (MAS PS Act requirement). Blockchain TX hashes stored in DBS FCRM as immutable evidence.','MANUAL',100.00),
('NPA-2026-001','fc_staff_training','Mandatory: DBS AML Digital Assets module (3 hours, updated Q4 2025). Annual recertification. Fireblocks security training (4 hours). Completion required before go-live access.','MANUAL',100.00),
...
('NPA-2026-001','fc_surveillance_tools','Elliptic (primary AML/blockchain analytics), Chainalysis KYT (secondary), DBS FCRM (internal case management), Firco Continuity (OFAC/UN sanctions screening)','MANUAL',100.00),
...
-- ================================================================
('NPA-2026-001','rda_compliance','BCBS 239 compliance applicable (DBS is a D-SIB). Digital asset custody data integrated into DBS Group risk data aggregation framework. AMA operational risk data feeds updated to include custody risk events.','MANUAL',95.00),
('NPA-2026-001','rda_data_sources','(1) Fireblocks ledger — custody positions, transaction history\n(2) CoinMetrics — market prices, NAV\n(3) Elliptic — AML risk scores\n(4) DBS FCRM — case management\n(5) Internal P&L system — fee income','MANUAL',100.00),
('NPA-2026-001','rda_aggregation_method','Daily batch aggregation: blockchain positions → DBS custody ledger → risk reports. Frequency: T+0 for positions, T+1 for MIS reports. Exception: manual escalation for breaches flagged same-day.','MANUAL',100.00),
...
('NPA-2026-001','tp_use_case_description','Fireblocks provides MPC (Multi-Party Computation) key management infrastructure for DBS Digital Asset Custody. Manages cold wallet key signing, transaction approval workflows, and portfolio administration for all client digital assets.','MANUAL',100.00),
...
('NPA-2026-001','tp_risk_mitigants','(1) Fireblocks enterprise agreement with 99.99% SLA, (2) DBS Fireblocks offline signing backup kit, (3) Contractual data portability clause (30-day exit), (4) Multi-geography nodes (US, EU, Asia redundancy)','MANUAL',100.00),
('NPA-2026-001','tp_data_classification','CLIENT_CONFIDENTIAL — Fireblocks holds key fragments only, NOT client assets. DBS retains full custody of assets.','MANUAL',100.00),
('NPA-2026-001','tp_integration_scope','API-based integration: Fireblocks Custody API → DBS Custody Ledger. Webhook-based real-time notifications. Admin portal for DBS ops team.','MANUAL',100.00),
...
('NPA-2026-001','tp_access_controls','Role-based: DBS ops staff (read), DBS ops supervisors (approve), DBS digital assets head (admin). Multi-factor authentication mandatory. IP allowlisting for DBS office networks.','MANUAL',100.00),
...
('NPA-2026-001','tp_cyber_assessment','CrowdStrike penetration test on DBS-Fireblocks integration: 2025-Q4. Result: 0 critical, 2 medium (patched). Fireblocks independent security audit: annually by Deloitte.','MANUAL',100.00),
('NPA-2026-001','tp_pdpa_compliance','Fireblocks Data Processing Agreement executed. Fireblocks processes key fragments only — no personal data. PDPA compliant as Fireblocks is a data processor under DBS instructions.','MANUAL',100.00),
('NPA-2026-001','info_security_assessment','Fireblocks ISS assessment completed: DBS ISS-2025-VENDOR-089. Result: APPROVED with conditions — quarterly security review, annual penetration test, immediate notification of any security incident.','MANUAL',100.00),
...
('NPA-2026-001','data_residency','Primary key fragments: AWS Singapore region (ap-southeast-1). Backup: AWS Tokyo region. No data stored outside SG/JP without explicit DBS approval. Compliant with MAS TRM cloud guidelines.','MANUAL',100.00);
