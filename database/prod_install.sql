...
('APP.2', 'STD_NPA_V2', 'Appendix 2: Intellectual Property', 'DBS and third-party IP considerations', 8),
...
('FLD_DBS_IP_EXISTS', 'APP.2', 'dbs_ip_exists', 'DBS IP Created/Used?', 'yesno', 0, NULL, 180),
('FLD_DBS_IP_DETAILS', 'APP.2', 'dbs_ip_details', 'DBS IP Details', 'textarea', 0, NULL, 181),
