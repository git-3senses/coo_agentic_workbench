...
('NPA-2026-004','problem_statement','DBS Private Banking clients seeking equity market participation without full capital at risk. Current offering lacks a compliant capital-protected structured note suitable for MAS-regulated AI clients who cannot accept full equity downside. Competitor banks (UBS, Julius Baer) actively offering capital-protected notes (CPNs), causing DBS Private Banking to lose wallet share on structured investment mandates.','MANUAL',100.00),
('NPA-2026-004','value_proposition','100% capital protection at maturity + 80% participation in APAC equity basket (DBS Singapore, HSBC, AIA, Samsung, TSMC) upside. 3-year tenor with quarterly liquidity window at NAV. USD 500K minimum. Expected to generate USD 18M in structured note sales in Year 1 across DBS Private Banking Singapore and Hong Kong.','MANUAL',100.00),
...
('NPA-2026-004','bu_benefit','Private Banking: USD 18M Year 1 structured note revenue. Gross margin: 1.2% on notional. Builds DBS structured products capability to compete with Swiss private banks. Unlocks equity participation product for conservative HNW clients.','MANUAL',100.00),
('NPA-2026-004','product_type','Structured Products','AUTO',99.00),
('NPA-2026-004','underlying_asset','APAC Equity Basket: DBS Group (40%), HSBC Holdings (20%), AIA Group (15%), Samsung Electronics (15%), TSMC (10%). Equal-weighted rebalanced annually.','MANUAL',100.00),
...
('NPA-2026-004','product_role','Principal — DBS issues the structured note from DBS Bank balance sheet. Client buys note from DBS.','AUTO',95.00),
...
('NPA-2026-004','product_lifecycle','DBS issues new series of CPNs quarterly. Each series has: issue date, 5-day subscription window, strike date (close of subscription), 3-year tenor. Maturity: capital + participation payment.','MANUAL',100.00),
('NPA-2026-004','product_features','• 100% capital protection at maturity (DBS Bank credit obligation)\n• 80% participation rate in APAC Equity Basket\n• APAC Basket: DBS, HSBC, AIA, Samsung, TSMC (equal weighted, annual rebalance)\n• Quarterly NAV liquidity window (bid-offer: 1.5% of formula NAV)\n• USD denomination, minimum subscription: USD 500,000\n• No coupon — zero-coupon note structure (all return at maturity)\n• ISDA-documented structured note (GMTN issuance program)','MANUAL',100.00),
...
('NPA-2026-004','cost_allocation','Embedded cost: zero-coupon bond purchase (DBS Treasury) ~85% of notional + call option purchase from GFM desk ~15% of notional. All-in option premium: 12% of notional for 3Y 80% participation call on basket.','MANUAL',100.00),
('NPA-2026-004','spv_involved','No — DBS Bank Ltd direct issuance under GMTN program. No SPV required.','MANUAL',100.00),
('NPA-2026-004','customer_segments','DBS Private Banking clients: HNW (USD 2M-10M net worth) and UHNW (>USD 10M). Age: 45-65 segment seeking capital protection. Conservative investors with equity market interest. Singapore and Hong Kong primary markets.','MANUAL',100.00),
...
('NPA-2026-004','customer_suitability','AI suitability assessment required. Risk profile: Conservative to moderate (capital protection allows conservative client access). Structured product risk acknowledgement form. DBS Private Banking RM sign-off on each subscription.','MANUAL',100.00),
...
('NPA-2026-004','distribution_channels','DBS Private Banking RM channel (voice execution only). DBS Online Banking: settlement instructions only (no self-execution). No third-party distribution.','MANUAL',100.00),
...
('NPA-2026-004','marketing_plan','Quarterly series: pre-launch RM briefing (1 week before subscription window). Client presentation decks. DBS Treasures Plus and Private Banking investor newsletter. Roadshow for UHNW clients >USD 5M subscription.','MANUAL',100.00),
('NPA-2026-004','pac_reference','PAC-2026-SP-007','MANUAL',100.00),
('NPA-2026-004','external_parties_involved','No — DBS self-issuance. Option hedge placed with DBS GFM desk (internal).','MANUAL',100.00),
('NPA-2026-004','esg_data_used','No','AUTO',100.00),
('NPA-2026-004','competitive_landscape','Capital protected notes highly competitive in APAC private banking. UBS offers similar at 90% protection, 70% participation. Julius Baer: 100% protection, 60% participation. DBS advantage: 80% participation rate (more attractive than Julius Baer), DBS/HSBC/AIA exposure (locally resonant APAC basket), competitive pricing.','ADAPTED',85.00),
('NPA-2026-004','market_opportunity','APAC Structured Products AUM: USD 800B+. Capital protected products: ~20% of structured product AUM. DBS Private Banking structured product AUM: currently USD 2B, target USD 5B by 2028. CPN represents key growth product.','ADAPTED',82.00),
('NPA-2026-004','break_even_timeline','At launch — issuance spread of 1.2% is recognised at Day 1. No ongoing operating cost (DBS balance sheet issuance). Fixed hedging cost (call option) pre-purchased at issuance.','MANUAL',100.00),
...
('NPA-2026-004','customer_accreditation','AI certification required and on file for all DBS Private Banking clients. Structured note risk disclosure additionally required at first subscription.','MANUAL',100.00),
...
('NPA-2026-004','customer_key_risks','(1) DBS credit risk (note is a DBS obligation — if DBS defaults, capital protection not guaranteed), (2) Opportunity cost: limited to 80% participation if basket outperforms significantly, (3) Liquidity risk: quarterly window only, not liquid daily, (4) Basket composition change risk: annual rebalancing may affect performance profile','MANUAL',100.00),
('NPA-2026-004','transfer_pricing','GFM Structured Products: sets option price charged internally to DBS PB. PB receives note issuance fee (30% of gross margin). FTP on zero-coupon bond embedding: SORA + 15bps internal funding rate on the "bond component" of the note.','MANUAL',100.00),
...
('NPA-2026-004','back_office_model','DBS Treasury Back Office: note issuance settlement under GMTN program. Client subscriptions: DBS cash account debit at subscription. Maturity: principal + participation payment from DBS bank account. All note lifecycle events settle via DBS internal accounts.','MANUAL',100.00),
...
('NPA-2026-004','booking_legal_form','DBS GMTN (Global Medium Term Note) Program Prospectus supplement. Structured note term sheet (standalone document per series). ISDA Master Agreement for option hedge (internal GFM-PB ISDA).','MANUAL',100.00),
...
('NPA-2026-004','portfolio_allocation','DBS balance sheet: zero-coupon bond component (Treasury). GFM trading book: call option (delta-managed). Private Banking: client subscriptions register.','MANUAL',100.00),
('NPA-2026-004','settlement_method','At subscription: T+2 DBS account debit. At maturity: T+2 USD credit to client account. Quarterly redemption: T+5 (NAV calculation + client notice required).','MANUAL',100.00),
...
('NPA-2026-004','accounting_treatment','DBS as issuer: note liability at amortised cost. Zero-coupon bond asset: FVTOCI (held-to-maturity intent). Call option asset: FVTPL (delta-hedged in trading book). Client as holder: note asset at amortised cost (principal protected = debt instrument).','MANUAL',100.00),
...
('NPA-2026-004','system_integration','Murex (option hedge) → Summit (note register). Summit → DBS account management system (subscription and redemption settlement). Quarterly NAV: MO Excel → client communication system (automated email). No new integrations required.','MANUAL',100.00),
...
('NPA-2026-004','risk_system','Murex: delta, vega, gamma, theta for call option component. DBS Group risk: note liability included in interest rate risk reporting. Bloomberg: equity vol surface for basket option pricing.','MANUAL',100.00),
...
('NPA-2026-004','mktdata_requirements','APAC equity prices: Bloomberg BGN (DBS SGX, HSBC HKEx, AIA HKEx, Samsung KRX, TSMC TWX). Equity implied vols: Bloomberg BVOL. SORA rate for zero-coupon bond pricing. All licences included in existing Bloomberg Enterprise agreement.','MANUAL',100.00),
...
('NPA-2026-004','continuity_measures','Murex DR replication. Summit: DBS Disaster Recovery site backup. GFM desk: manual pricing capability for structured note NAV calculation in case of Murex outage.','MANUAL',100.00),
...
('NPA-2026-004','custody_required','No — notes are registered on DBS note register. No physical certificates. No external custody.','MANUAL',100.00),

-- ================================================================
-- PC.III: PRICING MODEL
-- ================================================================
('NPA-2026-004','pricing_model_required','Yes','MANUAL',100.00),
('NPA-2026-004','pricing_methodology','Two-component pricing:\n1. Zero-coupon bond: PV of USD 100% principal at 3Y SORA + 15bps discount = ~86% of notional\n2. Call option: 3Y ATM call on APAC Equity Basket × 80% participation = ~12% of notional\n3. DBS margin: ~2% of notional (includes 1.2% front-end fee + 0.8% embedded spread)\nAll-in cost to DBS: 98% of notional. Client pays 100%. Margin: 2% = 1.2% + 0.8% embedded annual margin.','MANUAL',100.00),
...
('NPA-2026-004','pricing_model_name','DBS Capital Protected Note Pricing Model v2.1 (Murex + Excel MO validation)','MANUAL',100.00),
...
('NPA-2026-004','market_risk','Option hedge risk: delta, vega, gamma, theta on APAC equity basket call. Key risk: vega (vol change). DBS GFM desk delta-hedges daily using DBS/HSBC/AIA/Samsung/TSMC equity trades. Vega: managed within GFM equity derivatives vol limits. Zero-coupon bond: held-to-maturity (no P&L impact unless DBS credit risk, which is internal). Residual risk: basket correlation changes (model risk, see PC.V).','MANUAL',100.00),
('NPA-2026-004','mrf_fx_delta','Yes — basket includes KRX (KRW) and TWX (TWD) stocks. FX conversion to USD: DBS FX desk hedges currency components','AUTO',90.00),
...
('NPA-2026-004','credit_risk','Client view: DBS credit risk (note is DBS obligation). DBS credit risk internal: managed by DBS balance sheet — not an exposure to record separately. Option counterparty: internal GFM (no external credit risk). DBS credit risk to clients: nil (client pays upfront).','MANUAL',100.00),
('NPA-2026-004','counterparty_rating','DBS Bank Ltd (issuer): AA- (S&P, SG-listed). Clients: uncollateralised (they buy and pay upfront — no credit extension from DBS).','MANUAL',100.00),
('NPA-2026-004','credit_support_required','No — clients pay 100% upfront. DBS has no receivable from clients.','MANUAL',100.00),
...
('NPA-2026-004','custody_risk','N/A — notes are DBS-issued liabilities, not securities held in custody. Client holds a note (DBS liability), not a security in a custodian.','MANUAL',100.00),
('NPA-2026-004','regulatory_capital','Zero-coupon bond: 0% RWA (DBS internal asset). Call option: SA-CCR (equity derivative) ~8% RWA = $12M per USD 150M call exposure. Total RWA: ~$12M per USD 1.5B series. Capital efficiency: 99.2% of notional is zero-coupon (0% RWA) + 0.8% option.','MANUAL',100.00),
('NPA-2026-004','stress_scenarios','Scenario 1: APAC equity basket -40% (worst case 3-year scenario) — option expires worthless, clients receive 100% capital (DBS pays from zero-coupon proceeds). DBS P&L: option purchase cost written off (embedded in pricing). Scenario 2: basket +100% — DBS pays 80% participation ($50M per $500M series). Funded by call option purchase. No surprise to DBS. Scenario 3: SORA spike +300bps — zero-coupon bond mark-to-market loss for DBS (HTM intent, no P&L impact unless forced sale).','MANUAL',100.00),
('NPA-2026-004','stress_test_results','Stress scenarios modelled at option purchase time. DBS in all scenarios: capital obligation fully funded by zero-coupon proceeds at maturity. Participation obligation: fully covered by call option cost (pre-purchased). No unhedged DBS residual risk.','MANUAL',100.00),
('NPA-2026-004','reputational_risk','LOW-MEDIUM — capital protection reputation at stake. Risk: DBS credit event would threaten capital protection (mitigated by DBS AA- rating and SG government link). Client perception risk if basket underperforms (but clients accept no return as part of capital protection). Managed through clear client communication and term sheet.','MANUAL',100.00),
('NPA-2026-004','negative_impact','No','AUTO',100.00),
('NPA-2026-004','esg_assessment','Neutral — APAC equity basket includes companies with mixed ESG ratings. DBS and HSBC have strong ESG commitments. Samsung and TSMC improving. AIA: strong ESG governance. No dedicated green label for this product.','MANUAL',85.00),
...
('NPA-2026-004','monitoring_party','GFM Market Risk: option delta, vega, gamma daily. RMG Credit: DBS credit rating monitoring (triggers review if DBS downgraded below A-). Private Banking MO: client subscription register, quarterly NAV. Group Treasury: zero-coupon bond monitoring.','MANUAL',100.00),
...
('NPA-2026-004','licensing_requirements','MAS: DBS holds CMS licence for structured products distribution. GMTN Programme: existing MAS-registered Programme. No new licences required. HK: SFC Product Authorisation required for HK retail. HK institutional: private placement exemption.','MANUAL',100.00),
...
('NPA-2026-004','cross_border_regulations','HK: SFC distribution rules (private placement exemption for AI). Singapore: MAS FAA-N01 compliance. No US persons (Reg S). EU institutional: PRIIPs KID required. Taiwan: distribution via DBS Taiwan subject to FSC Taiwan structured product rules.','MANUAL',100.00),
('NPA-2026-004','legal_docs_required','• DBS GMTN Programme Prospectus and Supplement (series-specific)\n• Structured Note Term Sheet (individual client)\n• Risk Acknowledgement Form (signed by client and RM)\n• AI Suitability Assessment (on client file)\n• ISDA Master Agreement (for institutional subscriptions)\n• PRIIPs Key Information Document (EU institutions)','MANUAL',100.00),
('NPA-2026-004','sanctions_check','Clear - No Matches','AUTO',100.00),
('NPA-2026-004','aml_considerations','Private Banking: enhanced KYC completed for all HNW/UHNW clients. Source of wealth verified for subscriptions >USD 2M. No new AML requirements specific to capital protected note (DBS standard PB AML procedures apply).','MANUAL',100.00),
('NPA-2026-004','tax_impact','Client: note proceeds at maturity — capital gain vs income: tax treatment depends on jurisdiction (SG: no capital gains tax, HK: no capital gains tax, TW/ID: consult local tax adviser). DBS: management fee income — Singapore 17% corporate tax. Interest deduction: not applicable (no actual interest payments).','ADAPTED',88.00),
...
('NPA-2026-004','fair_value_treatment','Note liability: DBS balance sheet at amortised cost (debt issuance). Zero-coupon bond: FVTOCI (HTM intent). Call option: FVTPL (trading book). Client holding: amortised cost (capital protected note — no expected credit loss above DBS default probability).','MANUAL',100.00),
('NPA-2026-004','on_off_balance','On-balance sheet: note liability (DBS), zero-coupon bond asset (DBS). Off-balance sheet: call option (derivative, disclosed at fair value in SFP notes).','AUTO',90.00),
('NPA-2026-004','tax_jurisdictions','Singapore: DBS fee income — 17% corporate tax. Withholding tax: no WHT on note proceeds (Singapore-domiciled DBS Bank). HK: distribution income — 16.5% HK profits tax. No other jurisdictions for primary DBS booking.','MANUAL',100.00),
('NPA-2026-004','model_risk','Basket option model: Black-Scholes with Gaussian copula for correlation. Model risk: correlation assumptions (~0.5 for APAC basket). Risk: correlation breakdown in stress (DBS, HSBC, AIA may co-move more than modelled in financial crisis). Mitigant: conservative correlation assumption (0.4 vs observed 0.55). Quarterly model review vs realised correlation.','MANUAL',90.00),
('NPA-2026-004','country_risk','Singapore (DBS, HSBC SG-listed): Tier 1. HK (HSBC, AIA): Tier 1, minor HK political risk. Korea (Samsung KRX): Tier 2 (DPRK geopolitical risk). Taiwan (TSMC): Tier 2 (cross-strait risk). Country risk premium: embedded in equity vol assumptions for Samsung and TSMC. Max KRX + TWX weight: 25%, within DBS country risk limits.','MANUAL',90.00),
...
('NPA-2026-004','data_ownership','DBS Bank Ltd owns all client and trade data. Summit register: DBS proprietary system. Bloomberg market data: licensed use.','MANUAL',100.00),
('NPA-2026-004','data_stewardship','PB Operations Manager (client subscriptions, note register). GFM Risk (option pricing data). DBS AM (quarterly NAV data).','MANUAL',100.00),
...
('NPA-2026-004','data_retention','Note subscription records: 7 years (MAS SFA). Client KYC: 5 years post-relationship. NAV calculation records: 7 years. All records archived to DBS cold storage after 3 years.','MANUAL',100.00),
...
('NPA-2026-004','data_lineage','Client subscription → Summit note register → DBS Treasury → Maturity payment. Option hedge: GFM Murex → daily P&L. NAV: Murex option fair value + SORA discounted principal → NAV calculation sheet → client statement.','MANUAL',100.00),
...
-- ================================================================
('NPA-2026-004','booking_entity','DBS Bank Ltd, Singapore (GMTN programme issuer)','MANUAL',100.00),
('NPA-2026-004','sales_entity','DBS Bank Ltd, Singapore (Private Banking). DBS Bank (Hong Kong) Ltd for HK-domiciled clients.','MANUAL',100.00),
...
('NPA-2026-004','risk_taking_entity','DBS Bank Ltd Singapore (GFM Structured Products desk)','MANUAL',100.00),
('NPA-2026-004','risk_taking_location','Singapore','MANUAL',100.00),
('NPA-2026-004','processing_entity','DBS Bank Ltd Singapore (Private Banking Operations, GFM Operations)','MANUAL',100.00),
('NPA-2026-004','processing_location','Singapore','MANUAL',100.00),
('NPA-2026-004','counterparty','Accredited Investor clients of DBS Private Banking (HNW, UHNW). Internal GFM Structured Products desk (option hedge counterparty).','MANUAL',100.00),
('NPA-2026-004','hedge_entity','DBS Bank Ltd Singapore (GFM Equity Derivatives desk — manages basket call option and delta hedge)','MANUAL',100.00),

-- ================================================================
-- APP.2: INTELLECTUAL PROPERTY
-- ================================================================
('NPA-2026-004','dbs_ip_exists','Yes — DBS Capital Protected Note Series branded product, DBS APAC Equity Basket (proprietary weighting methodology)','MANUAL',100.00),
('NPA-2026-004','dbs_ip_details','DBS APAC Equity Basket: DBS proprietary weighting methodology (40/20/15/15/10). DBS Capital Protected Note brand. Note term sheet template (DBS Legal).','MANUAL',100.00),
...
-- ================================================================
('NPA-2026-004','aml_assessment','LOW RISK — Private Banking institutional product with enhanced KYC. All subscribers are AI-certified with source of wealth verified. No anonymous note subscriptions. Note subscriptions via DBS bank accounts only (no cash or third-party wire).','MANUAL',100.00),
('NPA-2026-004','terrorism_financing','LOW — note subscriptions require DBS bank account (full KYC on file). No anonymous note purchases. TF risk: minimal for capital protected note targeting HNW investors.','MANUAL',100.00),
('NPA-2026-004','sanctions_assessment','All subscribers screened at onboarding and periodic refresh. Note transfer: not permitted (no secondary market for listed notes). DBS basket constituents: DBS, HSBC, AIA, Samsung, TSMC — all screened, no sanctions exposure.','MANUAL',100.00),
('NPA-2026-004','fraud_risk','LOW — note is a DBS balance sheet obligation. Subscription via established PB client account. Key risks: (1) RM mis-selling: mitigated by suitability check and compliance oversight. (2) Fictitious subscriptions: mitigated by dual approval and back-office confirmation.','MANUAL',100.00),
('NPA-2026-004','bribery_corruption','LOW — Private Banking clients; arm''s length relationship. Anti-bribery policy applies to all RM relationships. Gift/entertainment limit: $150 per client per year under DBS policy.','MANUAL',100.00),
('NPA-2026-004','fc_risk_rating','LOW','MANUAL',100.00),
('NPA-2026-004','fc_mitigation_measures','• All subscriptions from pre-KYC''d DBS bank accounts\n• AI suitability assessment for every client subscription\n• RM dual-control approval for large subscriptions\n• Monthly note subscription AML review by compliance\n• Annual AML testing of structured products distribution by Internal Audit','MANUAL',100.00),

-- ================================================================
-- APP.4: RISK DATA AGGREGATION
-- ================================================================
('NPA-2026-004','rda_compliance','Structured note outstanding: included in DBS Group balance sheet RDA reporting. Option position: in GFM trading book risk aggregation. BCBS 239 compliant — existing infrastructure covers structured note and option data.','MANUAL',95.00),
