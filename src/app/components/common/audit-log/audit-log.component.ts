...
@Component({
    ...
    <div class="border-t border-[#2e2e2e] bg-[#111]">
      <div class="flex items-center justify-between px-6 py-2 cursor-pointer hover:bg-[#1a1a1a] transition-colors" (click)="toggle()">
        ...
        <lucide-icon [name]="expanded ? 'chevron-down' : 'chevron-up'" class="w-4 h-4 text-gray-500"></lucide-icon>
      </div>

      <div class="h-48 overflow-y-auto bg-[#0A0A0A] border-t border-[#2e2e2e]" *ngIf="expanded">
         <table class="w-full text-left border-collapse">
            <thead class="bg-[#141414] text-xs text-gray-500 font-mono sticky top-0">
               <tr>
            ...
            <tbody class="text-xs font-mono text-gray-400">
               <tr class="border-b border-[#1f1f1f] hover:bg-[#1f1f1f]/50 transition-colors">
                  <td class="px-6 py-2 text-gray-500">10:42:05 AM</td>
               ...
               <tr class="border-b border-[#1f1f1f] hover:bg-[#1f1f1f]/50 transition-colors">
                  <td class="px-6 py-2 text-gray-500">10:41:58 AM</td>
                  <td class="px-6 py-2 flex items-center gap-2">
                     <lucide-icon name="bot" class="w-3 h-3 text-purple-400"></lucide-icon>
                ...
                <tr class="border-b border-[#1f1f1f] hover:bg-[#1f1f1f]/50 transition-colors">
                  <td class="px-6 py-2 text-gray-500">10:41:45 AM</td>
                  <td class="px-6 py-2 flex items-center gap-2">
                  ...
                  <td class="px-6 py-2 text-gray-400">Initial Submission</td>
               </tr>
            </tbody>
         </table>
      </div>
