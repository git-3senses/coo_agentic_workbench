...
@Component({
   ...
   template: `
    <div class="flex h-[calc(100vh-64px)] overflow-hidden bg-gray-100">
      ...
      <aside class="w-64 border-r border-gray-200 bg-white flex flex-col items-center py-6 overflow-y-auto shrink-0 shadow-sm">
      ...
      <main class="flex-1 flex flex-col min-w-0 bg-white">
        ...
        <header class="h-16 border-b border-gray-200 bg-white flex items-center justify-between px-6 shrink-0 z-10">
          <div class="flex items-center gap-4">
             <div class="flex flex-col">
                <div class="flex items-center gap-2">
                    <h1 class="text-lg font-bold text-gray-900 tracking-tight">{{ workItemId }}</h1>
          ...
          <div class="flex items-center gap-3">
             <span class="text-xs text-gray-500 font-mono">Last updated: Just now</span>
             <button class="px-3 py-1.5 rounded bg-blue-600 hover:bg-blue-500 text-white text-xs font-medium transition-colors shadow-sm">
                Save & Continue
             </button>
          </div>
        </header>
        ...
        <div class="flex flex-1 overflow-hidden relative">
           ...
           <aside class="w-80 border-l border-gray-200 bg-gray-50 overflow-y-auto">
              <div class="p-4 border-b border-gray-200 flex items-center justify-between">
                 <h3 class="text-xs font-bold text-gray-500 uppercase tracking-wider">Active Agents</h3>
        ...
        <app-audit-log class="shrink-0 border-t border-gray-200"></app-audit-log>
      </main>
    </div>
  `,
   styles: [`
