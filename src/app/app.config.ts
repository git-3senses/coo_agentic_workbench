...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    importProvidersFrom(LucideAngularModule.pick({
      ...
      Download, GitMerge, LayoutGrid, Telescope, Gem, PlusCircle, List, ExternalLink, Edit3, Edit2, Paperclip,
      BarChart2, RefreshCw, Server, Tag, Quote
    }))
  ]
};
