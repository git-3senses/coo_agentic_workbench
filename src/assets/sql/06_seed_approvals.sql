...
('NPA-2026-001', 'RMG-Credit',       'RMG-Credit',       'APPROVED', 'USR-008', 'Jane Tan',     'jane.tan@dbs.com',     '2025-12-10 14:00:00', '2025-12-12 09:00:00', FALSE, '2025-12-08 10:00:00', 'Credit framework approved. Counterparty limits set at $50M.', NULL, NULL, NULL, 0, '2025-12-06 09:00:00'),
('NPA-2026-001', 'Finance (PC)',      'Finance',          'APPROVED', 'USR-009', 'Mark Lee',     'mark.lee@dbs.com',     '2025-12-11 16:30:00', '2025-12-13 09:00:00', FALSE, '2025-12-09 11:00:00', 'ROAE meets threshold. Revenue projection validated.', 'What is the expected VaR impact?', 'Based on historical analysis, VaR impact is estimated at $360K daily.', 'AI', 0, '2025-12-06 09:00:00'),
('NPA-2026-001', 'Legal & Compliance','Legal & Compliance','REWORK',   'USR-011', 'Lisa Wong',    'lisa.wong@dbs.com',    '2025-12-15 10:00:00', '2025-12-14 09:00:00', TRUE,  '2025-12-12 14:00:00', 'Cross-border legal opinion for HK jurisdiction still pending from external counsel.', 'Has the external legal opinion for HK been commissioned?', NULL, NULL, 1, '2025-12-06 09:00:00'),
('NPA-2026-001', 'MLR',              'MLR',              'APPROVED', 'USR-012', 'Ahmad Razak',  'ahmad.razak@dbs.com',  '2025-12-09 11:00:00', '2025-12-11 09:00:00', FALSE, '2025-12-07 09:00:00', 'AML/KYC requirements mapped. No concerns.', NULL, NULL, NULL, 0, '2025-12-06 09:00:00'),
...
('NPA-2026-002', 'RMG-Credit',       'RMG-Credit',       'APPROVED',      'USR-008', 'Jane Tan',     'jane.tan@dbs.com',     '2026-01-15 10:00:00', '2026-01-17 10:30:00', FALSE, '2026-01-13 08:00:00', 'Standard FX option risk within tolerance.', 0, '2026-01-12 10:30:00'),
('NPA-2026-002', 'Finance (PC)',      'Finance',          'UNDER_REVIEW',  'USR-009', 'Mark Lee',     'mark.lee@dbs.com',     NULL,                  '2026-02-14 10:30:00', FALSE, '2026-02-12 09:00:00', NULL, 0, '2026-01-12 10:30:00'),
('NPA-2026-002', 'Finance VP',        'Finance',          'PENDING',       NULL,      NULL,           NULL,                   NULL,                  NULL,                  FALSE, NULL,                   NULL, 0, '2026-01-12 10:30:00'),
('NPA-2026-002', 'Operations',       'Operations',       'APPROVED',      'USR-013', 'Kevin Patel',  'kevin.patel@dbs.com',  '2026-01-16 15:00:00', '2026-01-18 10:30:00', FALSE, '2026-01-14 10:00:00', 'Standard booking flow. No operational concerns.', 0, '2026-01-12 10:30:00'),
('NPA-2026-002', 'Technology',        'Technology',       'APPROVED',      'USR-014', 'Rachel Ng',    'rachel.ng@dbs.com',    '2026-01-17 11:00:00', '2026-01-19 10:30:00', FALSE, '2026-01-15 14:00:00', 'Murex configuration verified. No build required.', 0, '2026-01-12 10:30:00'),
('NPA-2026-002', 'MLR',              'MLR',              'APPROVED',      'USR-012', 'Ahmad Razak',  'ahmad.razak@dbs.com',  '2026-01-14 09:00:00', '2026-01-16 10:30:00', FALSE, '2026-01-13 10:00:00', 'No AML concerns for standard FX product.', 0, '2026-01-12 10:30:00');

-- NPA #3: Green Bond ETF (In risk assessment, partial sign-offs)
INSERT INTO npa_signoffs (project_id, party, department, status, approver_user_id, approver_name, approver_email, decision_date, sla_deadline, sla_breached, started_review_at, comments, loop_back_count, created_at) VALUES
('NPA-2026-003', 'RMG-Credit',       'RMG-Credit',       'UNDER_REVIEW',  'USR-008', 'Jane Tan',     'jane.tan@dbs.com',     NULL,                  '2026-02-14 08:00:00', FALSE, '2026-02-10 09:00:00', NULL, 0, '2025-12-15 08:00:00'),
...
INSERT INTO npa_signoffs (project_id, party, department, status, approver_user_id, approver_name, approver_email, decision_date, sla_deadline, sla_breached, started_review_at, comments, clarification_question, clarification_answer, clarification_answered_by, loop_back_count, created_at) VALUES
('NPA-2026-004', 'RMG-Credit',       'RMG-Credit',       'APPROVED',             'USR-008', 'Jane Tan',     'jane.tan@dbs.com',     '2026-01-20 14:00:00', '2026-01-22 11:00:00', FALSE, '2026-01-18 09:00:00', 'Credit limits approved with enhanced monitoring.', NULL, NULL, NULL, 0, '2026-01-15 11:00:00'),
('NPA-2026-004', 'Finance (PC)',      'Finance',          'APPROVED',             'USR-009', 'Mark Lee',     'mark.lee@dbs.com',     '2026-01-22 10:00:00', '2026-01-24 11:00:00', FALSE, '2026-01-19 14:00:00', 'Revenue model validated.', NULL, NULL, NULL, 0, '2026-01-15 11:00:00'),
...
('NPA-2026-004', 'Legal & Compliance','Legal & Compliance','UNDER_REVIEW',        'USR-011', 'Lisa Wong',    'lisa.wong@dbs.com',    NULL,                  '2026-02-14 11:00:00', FALSE, '2026-02-10 11:00:00', NULL, NULL, NULL, NULL, 0, '2026-01-15 11:00:00'),
...
INSERT INTO npa_signoffs (project_id, party, department, status, approver_user_id, approver_name, approver_email, decision_date, sla_deadline, sla_breached, started_review_at, comments, loop_back_count, created_at) VALUES
('NPA-2026-006', 'Business Head',     'Consumer Banking', 'APPROVED', 'USR-007', 'Amanda Lee',   'amanda.lee@dbs.com',   '2025-09-20 10:00:00', '2025-09-22 08:00:00', FALSE, '2025-09-18 08:00:00', 'Approved. Standard deposit enhancement.', 0, '2025-09-16 08:00:00'),
('NPA-2026-006', 'Group Product Head','Product Control',  'APPROVED', 'USR-006', 'David Chen',   'david.chen@dbs.com',   '2025-09-21 14:00:00', '2025-09-23 08:00:00', FALSE, '2025-09-19 09:00:00', 'Approved as Evergreen track.', 0, '2025-09-16 08:00:00');

-- NPA #7: FX Accumulator (Launched - all approved)
INSERT INTO npa_signoffs (project_id, party, department, status, approver_user_id, approver_name, approver_email, decision_date, sla_deadline, sla_breached, started_review_at, comments, loop_back_count, created_at) VALUES
('NPA-2026-007', 'RMG-Credit',       'RMG-Credit',       'APPROVED', 'USR-008', 'Jane Tan',     'jane.tan@dbs.com',     '2025-08-20 10:00:00', '2025-08-22 07:30:00', FALSE, '2025-08-18 08:00:00', 'Accumulator risk limits established.', 0, '2025-08-15 07:30:00'),
('NPA-2026-007', 'Finance (PC)',      'Finance',          'APPROVED', 'USR-009', 'Mark Lee',     'mark.lee@dbs.com',     '2025-08-22 14:00:00', '2025-08-24 07:30:00', FALSE, '2025-08-19 10:00:00', 'Pricing model validated. ROAE within targets.', 0, '2025-08-15 07:30:00'),
('NPA-2026-007', 'Finance VP',        'Finance',          'APPROVED', 'USR-010', 'Robert Koh',   'robert.koh@dbs.com',   '2025-08-25 09:00:00', '2025-08-27 07:30:00', FALSE, '2025-08-23 11:00:00', 'Approved. Monitor knock-out barrier closely.', 0, '2025-08-15 07:30:00'),
('NPA-2026-007', 'Operations',       'Operations',       'APPROVED', 'USR-013', 'Kevin Patel',  'kevin.patel@dbs.com',  '2025-08-21 16:00:00', '2025-08-23 07:30:00', FALSE, '2025-08-19 14:00:00', 'Operational readiness confirmed.', 0, '2025-08-15 07:30:00'),
('NPA-2026-007', 'Technology',        'Technology',       'APPROVED', 'USR-014', 'Rachel Ng',    'rachel.ng@dbs.com',    '2025-08-22 11:00:00', '2025-08-24 07:30:00', FALSE, '2025-08-20 09:00:00', 'Murex booking flow configured and tested.', 0, '2025-08-15 07:30:00'),
('NPA-2026-007', 'MLR',              'MLR',              'APPROVED', 'USR-012', 'Ahmad Razak',  'ahmad.razak@dbs.com',  '2025-08-19 15:00:00', '2025-08-21 07:30:00', FALSE, '2025-08-17 10:00:00', 'No AML concerns.', 0, '2025-08-15 07:30:00');

-- NPA #8: ESG Trade Finance (Blocked - 3 loop-backs, circuit breaker)
INSERT INTO npa_signoffs (project_id, party, department, status, approver_user_id, approver_name, approver_email, decision_date, sla_deadline, sla_breached, started_review_at, comments, loop_back_count, created_at) VALUES
('NPA-2026-008', 'RMG-Credit',       'RMG-Credit',       'REWORK',   'USR-008', 'Jane Tan',     'jane.tan@dbs.com',     '2025-11-15 10:00:00', '2025-11-10 10:00:00', TRUE,  '2025-11-05 09:00:00', 'ESG scoring methodology not aligned with DBS framework. Needs rework.', 3, '2025-10-15 10:00:00'),
('NPA-2026-008', 'Finance (PC)',      'Finance',          'REJECTED', 'USR-009', 'Mark Lee',     'mark.lee@dbs.com',     '2025-11-20 14:00:00', '2025-11-18 10:00:00', TRUE,  '2025-11-10 11:00:00', 'ROAE below minimum threshold. Revenue projections unrealistic.', 2, '2025-10-15 10:00:00'),
('NPA-2026-008', 'Legal & Compliance','Legal & Compliance','REWORK',  'USR-011', 'Lisa Wong',    'lisa.wong@dbs.com',    '2025-12-01 09:00:00', '2025-11-25 10:00:00', TRUE,  '2025-11-18 14:00:00', 'Vietnam legal framework insufficient. Need local counsel opinion.', 2, '2025-10-15 10:00:00'),
('NPA-2026-008', 'MLR',              'MLR',              'APPROVED', 'USR-012', 'Ahmad Razak',  'ahmad.razak@dbs.com',  '2025-10-25 11:00:00', '2025-10-27 10:00:00', FALSE, '2025-10-20 09:00:00', 'AML checks passed for all jurisdictions.', 0, '2025-10-15 10:00:00'),
...
('NPA-2026-009', 'RMG-Credit',  'RMG-Credit',  'UNDER_REVIEW', 'USR-008', 'Jane Tan',    'jane.tan@dbs.com',    '2026-02-14 14:00:00', '2026-02-10 10:00:00', 0, '2026-02-01 14:00:00'),
...
('NPA-2026-011', 'Business Head',      'Consumer Banking', 'APPROVED', 'USR-004', 'Jessica Wu',   'jessica.wu@dbs.com',   '2026-01-25 11:30:00', '2026-01-27 11:00:00', FALSE, 'Auto-approved via Evergreen track.', 0, '2026-01-25 11:00:00'),
('NPA-2026-011', 'Group Product Head', 'Product Control',  'APPROVED', 'USR-006', 'David Chen',   'david.chen@dbs.com',   '2026-01-25 12:00:00', '2026-01-27 11:00:00', FALSE, 'Evergreen approval confirmed.', 0, '2026-01-25 11:00:00');
...
INSERT INTO npa_loop_backs (project_id, loop_back_number, loop_back_type, initiated_by_party, initiator_name, reason, requires_npa_changes, routed_to, routing_reasoning, initiated_at, resolved_at, delay_days, resolution_type, resolution_details) VALUES
('NPA-2026-008', 1, 'APPROVAL_CLARIFICATION', 'RMG-Credit', 'Jane Tan', 'ESG scoring methodology needs alignment with DBS Sustainability Framework.', TRUE, 'MAKER', 'Requires fundamental ESG methodology rework.', '2025-10-25 10:00:00', '2025-11-01 14:00:00', 7.00, 'MAKER_FIXED', 'Maker updated ESG scoring to align with DBS framework v3.2.'),
...
('NPA-2026-008', 'APPROVER_QUESTION','The ESG scoring methodology has been revised 3 times. What assurance do we have the latest version meets DBS framework requirements?', 'Jane Tan', 'Credit Approver', FALSE, NULL, NULL, '2025-11-15 10:00:00'),
('NPA-2026-008', 'MAKER_RESPONSE',   'We have engaged the Group Sustainability team to co-develop the methodology. Version 3.2 has been validated against DBS Sustainability Framework.', 'Robert Tan', 'Maker', FALSE, NULL, NULL, '2025-11-18 09:00:00');
...
INSERT INTO npa_comments (project_id, comment_type, comment_text, author_name, author_role, generated_by_ai, ai_agent, ai_confidence, created_at) VALUES
('NPA-2026-012', 'SYSTEM_ALERT',     'HARD STOP: Product flagged as PROHIBITED. Leveraged crypto CFDs for retail clients violate MAS Notice SFA 04-N15 and DBS Internal Policy IP-2024-003.', 'Prohibited List Checker', 'Agent', TRUE, 'Prohibited List Checker', 100.00, '2026-02-01 15:01:00'),
