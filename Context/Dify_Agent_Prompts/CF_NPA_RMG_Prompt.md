...
# This is a CHATFLOW (conversational, multi-turn) for Draft Builder sign-off guidance
# Updated: 2026-02-23 | Aligned to NPA_FIELD_REGISTRY (339 fields)
...
@@NPA_META@@{"fields":[
  ...
  {"field_key":"credit_risk_rating","label":"Credit Risk Rating","value":"Medium","confidence":0.75}
]}@@END_META@@
```
