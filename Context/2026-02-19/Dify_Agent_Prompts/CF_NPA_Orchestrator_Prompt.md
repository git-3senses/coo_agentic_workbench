...
# Version: 3.0 — Split from unified Orchestrator into Tier 2 NPA Domain Orchestrator
...
4. **Route** to the correct specialist agent (Ideation, Classifier, Risk, Autofill, Governance, Query)
...
- Intent classification within the NPA domain (7 intents)
