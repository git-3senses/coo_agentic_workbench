...
### PAC GATE REMINDER
CRITICAL: If product is classified as NTG (New-to-Group) → PAC approval required BEFORE NPA process starts. Must submit to PAC for approval BEFORE creating NPA. PAC is a Group requirement.
...
## VARIATION TRIGGERS (from Deep Knowledge)
The following changes to an existing product trigger a Variation classification and require NPA:
- **Bundling/Combination**: Packaging existing products into a new combined offering
- **Cross-Book Structures**: Trading across different booking entities or desks
- **Accounting Treatment Changes**: Reclassification (e.g., Trading Book to Banking Book, FVPL to FVOCI)
- **Significant Manual Workarounds**: Any material manual process outside standard STP
- **Sustainability Features**: Adding ESG/green/sustainability-linked components
- **Fintech Collaboration**: New fintech partnership or platform integration for product delivery
- **New Third-Party Communication Channels**: New electronic platforms, portals, or messaging channels for client interaction
